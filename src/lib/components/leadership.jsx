...
import ukur from "../../app/Assets/images/profile.jpg";
  ...
  return (
    <div className="bg-white py-10 sm:py-13">
      ...
      <div className="mx-auto max-w-7xl px-4 lg:px-5">
        ...
        <ul
          role="list"
          className="mx-auto mt-20 grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 sm:grid-cols-2 lg:mx-0 lg:max-w-none md:grid-cols-4 lg:grid-cols-4"
        >
